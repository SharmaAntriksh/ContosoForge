...
scale:
  products:
    ...
    rows: 7136            # target product count (trims or expands to fit)
```
...
| `synthetic` | `synthetic_products.parquet` | 4,839 | 59 | Retail + electronics brands (Nike, Samsung, IKEA, etc.) |
| `all` | both files combined | ~7,096 | 70 | Combined with Contoso house brand trimmed to 490 |
